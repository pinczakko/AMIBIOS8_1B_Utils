...
(offset here means file offset of the component). Now, extract the component: 
code:
...
In the first variant, this program will combine the component named component_filename
